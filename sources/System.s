...
SystemInitializeVideo:
    ...
    ; VRAM の転送の初期化
    ld      hl, #(_videoTransfer + 0x0000)
    ld      de, #(_videoTransfer + 0x0001)
    ld      bc, #(VIDEO_TRANSFER_VRAM_SIZE * VIDEO_TRANSFER_SIZE - 0x0001)
    ld      (hl), #0x00
    ldir
...
_SystemTransferVram::
    ...
    out     (c), a
    ld      c, d
    ld      a, (_videoTransfer + VIDEO_TRANSFER_VRAM_0_BYTES + 0x0001)
    or      a
    jr      z, 101$
100$:
    ld      b, #0x00
    ...
    jr      nz, 100$
101$:
    ld      a, (_videoTransfer + VIDEO_TRANSFER_VRAM_0_BYTES + 0x0000)
    or      a
    jr      z, 109$
    ld      b, a
    otir
109$:
    ...
    out     (c), a
    ld      c, d
    ld      a, (_videoTransfer + VIDEO_TRANSFER_VRAM_1_BYTES + 0x0001)
    or      a
    jr      z, 111$
110$:
    ld      b, #0x00
    ...
    jr      nz, 110$
111$:
    ld      a, (_videoTransfer + VIDEO_TRANSFER_VRAM_1_BYTES + 0x0000)
    or      a
    jr      z, 119$
    ld      b, a
    otir
119$:
    ...
    out     (c), a
    ld      c, d
    ld      a, (_videoTransfer + VIDEO_TRANSFER_VRAM_2_BYTES + 0x0001)
    or      a
    jr      z, 121$
120$:
    ld      b, #0x00
    ...
    jr      nz, 120$
121$:
    ld      a, (_videoTransfer + VIDEO_TRANSFER_VRAM_2_BYTES + 0x0000)
    or      a
    jr      z, 129$
    ld      b, a
    otir
129$:
    ...
    out     (c), a
    ld      c, d
    ld      a, (_videoTransfer + VIDEO_TRANSFER_VRAM_3_BYTES + 0x0001)
    or      a
    jr      z, 131$
130$:
    ld      b, #0x00
    ...
    jr      nz, 130$
131$:
    ld      a, (_videoTransfer + VIDEO_TRANSFER_VRAM_3_BYTES + 0x0000)
    or      a
    jr      z, 139$
    ld      b, a
    otir
